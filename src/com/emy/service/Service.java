...
import com.emy.service.impl.ServiceAddress;
import com.emy.service.impl.ServiceNews;
import com.emy.service.impl.ServiceUser;
...
public class Service {
    ...
    public void doServlet(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (obj != null && act != null) {
            ...
            switch (obj) {
                case "user":
                    serviceUser.accept(new ServiceUser(request, response), act);
                    break;
                case "address":
                    serviceAddress.accept(new ServiceAddress(request, response), act);
                    break;
                case "news":
                    serviceNews.accept(new ServiceNews(request, response), act);
                    break;
                default:
            }
        }
