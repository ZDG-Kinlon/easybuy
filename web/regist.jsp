    ...
    <tr>
        ...
        <td>
            <button onclick="window.location.href='<%=request.getContextPath()%>/login.jsp';" style="margin: 5px;"
                    class="ui-button ui-corner-all ui-widget">用户登录
            </button>
        </td>
    </tr>
    </tbody>
        ...
        <form class="rl_form" action="<%=request.getContextPath()%>/url" method="post">
            ...
            <table class="rl_table" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="35">
                    ...
                    <td class="rl_td_inp"><input class="rl_input text ui-widget-content ui-corner-all" type="text"
                                                 id="loginName"
                                                 maxlength="20"
                ...
                <tr height="35">
                    ...
                    <td class="rl_td_inp"><input class="rl_input text ui-widget-content ui-corner-all" type="password"
                                                 id="password"
                                                 value="" required></td>
                ...
                <tr height="35">
                    ...
                    <td class="rl_td_inp"><input class="rl_input text ui-widget-content ui-corner-all" type="email"
                                                 name="email"
                                                 maxlength="80"
                ...
                <tr height="30" style="text-align: center">
                    <td class="reg_chk_btn" colspan="2">
                        <input class="rl_btn" type="checkbox" id="chk_btn"><span style="color: #f00; ">同意条款规定</span>
                    </td>
                    </td>
                    <td></td>
                </tr>
