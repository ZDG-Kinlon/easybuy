    ...
    <form class="reg_form" action="<%=request.getContextPath()%>/url" method="post">
        ...
        <table class="rl_table" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr height="35">
                ...
                <td class="rl_td_inp"><input class="rl_input ui-autocomplete-input" type="password" id="password" value="">
            ...
            <tr height="35">
                ...
                <td class="rl_td_inp"><input class="rl_input ui-autocomplete-input" type="text" name="userName" maxlength="20"
            ...
            <tr height="35">
                ...
                <td class="rl_td_inp"><input class="rl_input ui-autocomplete-input" type="text" minlength="18" maxlength="18"
                                             placeholder="18个字符"
            ...
            <tr height="35">
                ...
                <td class="rl_td_inp"><input class="rl_input ui-autocomplete-input" type="email" name="email" maxlength="80"
            ...
            <tr height="35">
                ...
                <td class="rl_td_inp"><input class="rl_input ui-autocomplete-input" type="text" minlength="11" maxlength="11"
                                             placeholder="11个数字"
            ...
            <tr height="60">
                <td class="rl_td_btn" colspan="2">
                    <input class="rl_btn ui-button ui-corner-all ui-widget" id="reg_btn" type="submit" value="递交修改">
                </td>
                <td></td>
            </tr>
            <!--递交按钮    E-->
